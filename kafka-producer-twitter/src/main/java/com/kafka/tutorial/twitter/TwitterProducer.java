package com.kafka.tutorial.twitter;
...
public class TwitterProducer {
            ...
            if(msg == null) {
                ...
                producer.send(new ProducerRecord<>("twitter_tweets", null, msg), new Callback() {
                    ...
                    public void onCompletion(RecordMetadata metadata, Exception exception) {
                        if(exception != null) {
                            logger.error("Something has happened", exception);
                        }
                    }
                });
            }
    ...
    private KafkaProducer<String,String> createKafkaProducer() {
        ...
        properties.setProperty(ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION, "5"); // Kafka2.0>=1.1 so we can keep this as 5. Use 1 otherwise.
